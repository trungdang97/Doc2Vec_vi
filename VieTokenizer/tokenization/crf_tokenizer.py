...
class CrfTokenizer(BaseTokenizer):
    def __init__(self, config_root_path="", bi_grams_path='VieTokenizer/datasets/bi_grams.txt', tri_grams_path='VieTokenizer/datasets/tri_grams.txt',
                 crf_config_path='VieTokenizer/tokenization/crf_config.txt',
                 features_path='VieTokenizer/tokenization/crf_features.txt',
                 model_path='VieTokenizer/vi-segmentation.crfsuite',
...
def test_base():
    params = load_crf_config('VieTokenizer/tokenization/crf_config.txt')
    print(params)
    ...
    crf_tokenizer_obj.train('datasets/samples/data.txt')
...
def test():
    crf_tokenizer_obj = CrfTokenizer(model_path='VieTokenizer/tokenization/pretrained_tokenizer.crfsuite')
    # test_sent = "Thuế thu nhập cá nhân của thạc sĩ Đỗ Đình Hưng."
    # tokenized_sent = crf_tokenizer_obj.get_tokenized(test_sent)
    # print(tokenized_sent)
    # tokens = crf_tokenizer_obj.tokenize(test_sent)
    # print(tokens)

    # f = open('datasets/vi/uts2017_bank_no_label_cleaned/no_label_cleaned/train.txt','r',encoding='utf-8')
    # f = open('datasets/vi/uts2017_bank_no_label_cleaned/no_label_cleaned/test.txt','r',encoding='utf-8')
    # f = open('datasets/vi/vlsp2018_sa_hot_no_label_cleaned/no_label_cleaned/dev.txt','r',encoding='utf-8')
    # f = open('datasets/vi/vlsp2018_sa_hot_no_label_cleaned/no_label_cleaned/test.txt','r',encoding='utf-8')
    f = open('datasets/vi/vlsp2018_sa_hot_no_label_cleaned/no_label_cleaned/train.txt','r',encoding='utf-8')
    
    sentences = f.readlines()
    f.close()

    # w = open('datasets/vi/uts2017_bank_no_label_cleaned/no_label_cleaned/train.tok.txt','w+',encoding='utf-8')
    # w = open('datasets/vi/uts2017_bank_no_label_cleaned/no_label_cleaned/test.tok.txt','w+',encoding='utf-8')
    # w = open('datasets/vi/vlsp2018_sa_hot_no_label_cleaned/no_label_cleaned/dev.tok.txt','w+',encoding='utf-8')
    # w = open('datasets/vi/vlsp2018_sa_hot_no_label_cleaned/no_label_cleaned/test.tok.txt','w+',encoding='utf-8')
    w = open('datasets/vi/vlsp2018_sa_hot_no_label_cleaned/no_label_cleaned/train.tok.txt','w+',encoding='utf-8')

    for s in sentences:
        token = crf_tokenizer_obj.get_tokenized(s)
        w.write(token+'\n')
    w.close()
