...
def test_clean_file():
    # data_path = '../data/tokenized/samples/html/Tuan1.htm'
    data_path = '/media/hungdo/SYSTEM/Users/HungDo/Downloads/ThucDonTrongTuan/Tuan1.htm'
    output_path = '../data/tokenized/samples/training/test.txt'
    clean_html_file(data_path, output_path)


def test_clean_files_in_dir():
    input_dir = '/media/hungdo/SYSTEM/Users/HungDo/Downloads/ThucDonTrongTuan'
    output_dir = '../data/tokenized/sample/training'
