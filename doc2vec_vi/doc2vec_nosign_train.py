...
model_path = "doc2vec_vi/models/corpus-title-1135.model"  # path to trained model
corpus_path = "datasets/vi/corpus-title-200000.tok.nosign.txt"  # path to corpus file, Too large cannot be put on Git
nosign_path = "doc2vec_vi/models/corpus-title.nosign-trained.model" # path to model bonus trained with no sign
...
def Train():   
    try:
        ...
        while(corpus_range < max_range):
            ...
            model.save(nosign_path)  # save model
            batch_end = time.time()
